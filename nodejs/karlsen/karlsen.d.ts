 ...
 * Wallet API for interfacing with Rusty Karlsen Wallet implementation.
 */
...
/**
 * Transaction record generated by the Karlsen Wallet SDK.
...
*/
   ...
   */
  static fromRaw(pre_pow_hash: string, timestamp: bigint, target_bits: number | null | undefined, header_version: number): PoW;
  /**
 ...
 * @category Wallet SDK
 */
export function karlsenToSompi(karlsen: string): bigint | undefined;
 ...
 * @category Wallet SDK
 */
export function sompiToKarlsenString(sompi: bigint | number | HexString): string;
 ...
 * @category Wallet SDK
 */
export function sompiToKarlsenStringWithSuffix(sompi: bigint | number | HexString, network: NetworkType | NetworkId | string): string;
